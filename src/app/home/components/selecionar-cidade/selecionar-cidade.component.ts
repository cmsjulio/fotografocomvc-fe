...
export class SelecionarCidadeComponent implements OnInit {
  public locationList: Location[] = [{id: 1, locationCity: "rio de janeiro", locationState: "RJ"}, {id: 2, locationCity: "sao paulo", locationState: "SP"},{id: 3, locationCity: "niterói", locationState: "RJ"}, {id: 4, locationCity: "santos", locationState: "SP"}];
  ...
  public submitLocationRequest(): void {
    if (this.isLocationSelected){
      console.log('submeter chamada com busca por local para ir pra próxima página')
    }
  }
